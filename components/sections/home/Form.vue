        ...
        <div class="bg-white shadow-xl p-4 rounded-lg mt-8">
            ...
            <div class="flex border-t-2 border-gray-200">
              ...
              <div class="flex-1 flex flex-col justify-center pl-8">
                <form class="flex">
                  <label class="-mt-2 block flex-1 mr-4">
                    <span class="text-gray-700">Quantidade:</span>
                    <input type="number" v-model="form.pedido.capote.qtd" class="form-input mt-1 block w-full">
                  </label>
                  <label class="-mt-2 block flex-1 mr-4">
                    <span class="text-gray-700">Prazo:</span>
                    <input class="form-input mt-1 block w-full"
                      :value="form.pedido.capote.prazo"
                     readonly>
                  </label>
                  <label class="-mt-2 block flex-1">
                    <span class="text-gray-700">Valor:</span>
                    <input v-mask="'R$ ####,00'" class="form-input mt-1 block w-full"
                      :value="form.pedido.capote.valorUnitario * form.pedido.capote.qtd"
                     readonly>
                  </label>
                </form>
              </div>
          ...
          <footer class="bg-block-400 border-t-2 border-block-100 -mx-4 -mb-4 p-4 rounded-b-lg flex justify-between">
            <label class="block flex items-center">
              ...
              <input v-model="form.dados.email" class="form-input w-20">
            </label>
            <label class="block flex items-center">
              <span class="-mt-2 text-block-100 mr-4">Valor total estimado:</span>
              <input v-model="form.dados.email" class="form-input w-48">
            </label>
          </footer>
        </div>
        <div class="bg-white shadow-xl p-4 rounded-lg mt-8">
...
<style lang="css">
  ...
  .icones svg{
    padding: 5px;
    @apply w-24 h-24 bg-white shadow-lg rounded-full flex items-center justify-center;
  }

  .icones h2{
    font-size: 22px;
    font-family: 'al', sans-serif;
    @apply text-center text-block-400 mt-2;
  }
</style>
