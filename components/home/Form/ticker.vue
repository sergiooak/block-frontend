<template lang="html">
  <div class="flex items-center box-content mt-1">
    <div class="cursor-pointer bg-block-400 px-2 rounded-l text-block-100 flex items-center justify-center h-12">
    ...
    <input type="text" inputmode="numeric" class="form-input block w-20 rounded-none border-l-0 border-r-0 h-12">
    <div class="cursor-pointer bg-block-400 px-2 rounded-r text-block-100 flex items-center justify-center h-12">
