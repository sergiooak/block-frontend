      ...
      <div class="flex flex-col md:flex-row my-4 border-b-2 border-block-100 -mx-8 px-8 pb-8 md:pb-2">
        ...
        <div class="flex flex-col md:flex-row items-center md:ml-8">
            ...
            <div class="flex flex-col mb-4">
              ...
              <label class="block flex-1 mt-4 md:mt-2">
                ...
                <div class="flex items-center box-content mt-1">
                  ...
                  <input v-model="pedido.viseira.qtd" type="text" inputmode="numeric" class="text-center form-input block w-full md:w-20 rounded-none border-l-0 border-r-0 h-12">
          ...
          <div class="flex w-full mt-4 md:mt-0 flex-col md:flex-row md:ml-12">
            ...
            <label class="md:-mt-2 block flex-1">
            ...
            <div class="flex flex-col mb-4">
              <label class="block flex-1 mt-4 md:-mt-2">
                ...
                <div class="flex items-center box-content mt-1">
                  ...
                  <input v-model="pedido.mascara.qtd" type="text" inputmode="numeric" class="text-center form-input block w-full md:w-20 rounded-none border-l-0 border-r-0 h-12">
            ...
            <div class="flex flex-col mb-4">
              <label class="block flex-1 mt-4 md:-mt-2">
                ...
                <div class="flex items-center box-content mt-1">
                  ...
                  <input v-model="pedido.capote.qtd" type="text" inputmode="numeric" class="text-center form-input block w-full md:w-20 rounded-none border-l-0 border-r-0 h-12">
