      ...
      <ul class="flex flex-wrap w-10/12">
        ...
        <li class="flex w-1/2 animated fadeIn" style="animation-delay: .8s">
          ...
          <div  class="flex-1">
            ...
            <p class="text-lg text-block-300">Prazo de entrega de até cinco dias úteis<br />
        ...
        <li class="flex w-1/2 mt-8 animated fadeIn" style="animation-delay: 1s">
          ...
          <div  class="flex-1">
            ...
            <p class="text-lg text-block-300">Consulte opções de pagamentos e descontos especiais para grande volume</p>
          </div>
        </li>
      </ul>
